...
Reserves mobile routes for the learner dashboard and next-action summary in BAYA.

## Responsibilities

Defines the future navigation entry points and route-level states for the learner dashboard and next-action summary.
...
Supports navigation and learner performance summaries.
