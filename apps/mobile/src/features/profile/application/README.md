...
the Clean Architecture use-case layer for learner profile management

## Responsibilities

use cases, workflows, commands and queries, input and output models, orchestration of domain objects, and ports required for profile presentation, learner preferences, identity linkage, and privacy-aware profile updates
