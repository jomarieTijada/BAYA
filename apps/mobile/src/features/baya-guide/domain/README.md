...
the innermost Clean Architecture layer for controlled in-app learning guidance

## Responsibilities

business entities, value objects, domain rules, repository and evaluator contracts, and domain errors for hints, corrective messages, encouragement, repeated-error responses, and error-code-to-message orchestration
