...
the Clean Architecture use-case layer for structured Baybayin instruction

## Responsibilities

use cases, workflows, commands and queries, input and output models, orchestration of domain objects, and ports required for characters, sounds, kudlit, syllables, words, phrases, content versions, and lesson progression
