...
the Clean Architecture use-case layer for first-run learner setup and readiness

## Responsibilities

use cases, workflows, commands and queries, input and output models, orchestration of domain objects, and ports required for onboarding state, consent-aware setup, learner preferences, and completion decisions
