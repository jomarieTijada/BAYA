...
Adapts external requests and responses for learner identity and access boundaries.

## Responsibilities

Maps API inputs to application use cases and use-case outcomes to versioned transport responses for learner identity, authentication-token validation, learner profiles, and authorization boundaries.
